...
countrylist = list(questions.keys())
...
while len(countrylist) > current_index:
    ...
    correct_answer = questions[current_country]
...
if review.lower().strip() == "answers":
    ...
    for items in incorrect_answers:
        correct_capital = questions[items].capitalize()
...
if review.lower().strip() == "review":
    ...
    while review_index < len(incorrect_answers):
        ...
        correct_review_answer = questions[current_review_country]
    ...
    if final_review_score == 100:
        ...
        print("Correct Answers") # Need to add in correct answers
        for i in incorrect_review_answers:
            correct_review_capital = questions[i].capitalize()
...
# Use .append to add incorrect questions to a list
